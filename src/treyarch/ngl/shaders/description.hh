...
namespace treyarch { namespace ngl { namespace shaders {
    ...
    enum class e_shader_program : u16 {
        ...
        internal_quad_pc_vertex,
        internal_screen_pc_vertex,
        internal_screen_pcuv_vertex,
        internal_screen_pcuv4_vertex,
        internal_screen_puv_material_vertex,
        internal_font_vertex,
        internal_vertex_color_pixel,
        internal_texture_modulate_pixel,
        internal_movie_yuv_pixel,
        internal_white_pixel,
        internal_restore_depth_pixel,
        internal_four_texture_average_pixel,
        internal_fog_pixel,
        internal_depth_copy_pixel,
        internal_rawz_depth_copy_pixel,
        count,
    };
