...
#if NGL_SM_BABYPHATNORMAL_FORCE_COLOR
...
#if NGL_SM_BABYPHATNORMAL_SHADOW_COUNT > 0
...
#endif
#if NGL_SM_BABYPHATNORMAL_SHADOW_COUNT > 1
...
SamplerState emissiveness_sampler     : register(s7);
SamplerState specular_exponent_sampler : register(s8);
SamplerState opacity_sampler          : register(s9);
SamplerState specularity_sampler      : register(s10);
SamplerState reflectivity_sampler     : register(s11);
...
#elif NGL_SM_BABYPHATNORMAL_SHADOW_COUNT == 2
