...
row_major float4x4 texture_coordinate_0_matrix   : register(c20);
row_major float4x4 texture_coordinate_1_matrix   : register(c24);
...
row_major float4x4 compressed_to_screen          : register(c36);
...
float4 compressed_to_local  : register(c48);
...
struct vertex_output {
    ...
    float2 horizon_coordinates    : TEXCOORD9;
};
